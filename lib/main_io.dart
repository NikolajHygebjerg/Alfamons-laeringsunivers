        ...
        ShellRoute(
          builder: (context, state, child) {
            ...
            if (!kIsWeb) {
              WidgetsBinding.instance.addPostFrameCallback((_) {
                ...
                unawaited(applyPhoneAuthAdminOrientations(context, path));
              });
            }
            return child;
          },
          routes: [
              ...
              routes: [
                GoRoute(
                  ...
                  builder: (context, state) {
                    ...
                    return KidMathBrowseScreen(
                        kidId: kidId, folderId: folderId);
                  },
                ),
                GoRoute(
                  path: 'play/:folderId',
            ...
            GoRoute(
              ...
              builder: (context, state) {
                final kidId = state.pathParameters['kidId']!;
                return KidLibraryScreen(
                  kidId: kidId,
                  skipIntroOnOpen: state.extra == true,
                );
              },
              routes: [
                GoRoute(
                ...
                GoRoute(
                  ...
                  builder: (context, state) {
                    ...
                    return KidLibraryGroupScreen(
                        kidId: kidId, groupId: groupId);
                  },
                ),
              ],
            ),
            ...
            GoRoute(
              ...
              routes: [
                GoRoute(
                  ...
                  builder: (context, state) {
                    final kidId = state.pathParameters['kidId']!;
                    final computerMatchId =
                        state.uri.queryParameters['matchId'];
                    return KidSpilScreen(
                        kidId: kidId, computerMatchId: computerMatchId);
                  },
                ),
                GoRoute(
                  path: 'ven',
