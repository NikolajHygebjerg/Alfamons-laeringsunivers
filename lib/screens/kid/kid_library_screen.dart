      ...
      child: Row(
        ...
        children: [
          Expanded(
            child: Row(
              ...
              children: [
                ...
                _NavItem(icon: Icons.library_books, label: 'Bibliotek', selected: true),
                _NavItem(icon: Icons.pets, label: 'Alfamons', onTap: () => context.go('/kid/alfamons/${widget.kidId}')),
          ...
          TextButton(
            ...
            child: const Text('Log ud', style: TextStyle(color: Colors.white70, fontWeight: FontWeight.w600)),
          ),
        ],
      ),
    );
...
class _NavItem extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final child = Column(mainAxisSize: MainAxisSize.min, children: [
      Icon(icon, color: selected ? Colors.amber : Colors.white70, size: 26),
      Text(label, style: TextStyle(color: selected ? Colors.amber : Colors.white70, fontSize: 11)),
    ]);
